...
bots = [
    {
        ...
        "name": "Analyst Bot",
        "parameters": [
            {"type": "STRING", "name": "Source Group", "key": "SOURCE_GROUP", "description": "OSINT Source group to inspect", "id": 54},
            {
                "type": "STRING",
                "name": "Regular Expression",
                "key": "REGULAR_EXPRESSION",
                "description": "Regular expression for data analysis",
                "id": 55,
            },
            {
                "type": "STRING",
            ...
            },
            {
                ...
                "key": "REFRESH_INTERVAL",
                "description": "How often is this bot doing its job",
                "id": 57,
            },
        ],
        "description": "Bot for news items analysis",
        "id": "edddf6f5-71cc-46cf-8775-4679bc30eaa6",
    },
    {
        "type": "GROUPING_BOT",
        "name": "Grouping Bot",
        "parameters": [
            {"type": "STRING", "name": "Source Group", "key": "SOURCE_GROUP", "description": "OSINT Source group to inspect", "id": 58},
            {
                "type": "STRING",
                "name": "Regular Expression",
                "key": "REGULAR_EXPRESSION",
        ...
        "id": "aaa33aa9-94c0-49e9-b230-8d4d5a5617cd",
    },
    {
        "type": "NLP_BOT",
        "name": "NLP Bot",
        "parameters": [
            {"type": "STRING", "name": "Source Group", "key": "SOURCE_GROUP", "description": "OSINT Source group to inspect", "id": 61},
            {"type": "STRING", "name": "language", "key": "LANGUAGE", "description": "language','", "id": 62},
            {
                "type": "NUMBER",
                "name": "Refresh Interval",
                "key": "REFRESH_INTERVAL",
        ...
        "id": "1f3cd99d-cb58-4c92-8e62-7c652c3004de",
    },
    {
        "type": "TAGGING_BOT",
        "name": "Tagging Bot",
        "parameters": [
            {"type": "STRING", "name": "Source Group", "key": "SOURCE_GROUP", "description": "OSINT Source group to inspect", "id": 64},
            {"type": "STRING", "name": "Keywords", "key": "KEYWORDS", "description": "Keywords to Tag on seperated by ','", "id": 65},
            {
                "type": "NUMBER",
                "name": "Refresh Interval",
                "key": "REFRESH_INTERVAL",
        ...
        "id": "b3fffe3a-bf40-4a84-beb0-994cee4202b0",
    },
]
