...
bots = [
    {
        ...
        "name": "Analyst Bot",
        "parameters": [
            {"type": "STRING", "name": "Source Group", "key": "SOURCE_GROUP", "description": "OSINT Source group to inspect", "id": 0},
            {
                "type": "STRING",
    ...
    },
    {
        ...
        "parameters": [
            {"type": "STRING", "name": "Source Group", "key": "SOURCE_GROUP", "description": "OSINT Source group to inspect", "id": 0},
            {"type": "STRING", "name": "language", "key": "LANGUAGE", "description": "language','", "id": 0},
            {
                "type": "NUMBER",
                "name": "Refresh Interval",
                "key": "REFRESH_INTERVAL",
    ...
    },
    {
        ...
        "parameters": [
            {"type": "STRING", "name": "Source Group", "key": "SOURCE_GROUP", "description": "OSINT Source group to inspect", "id": 0},
            {"type": "STRING", "name": "Keywords", "key": "KEYWORDS", "description": "Keywords to Tag on seperated by ','", "id": 0},
            {
                "type": "NUMBER",
                "name": "Refresh Interval",
                "key": "REFRESH_INTERVAL",
