...
def test_filter_by_word_list_include_multiple_list(rss_collector, input_news_items, expected_news_items):
    ...
    include_list_results = (
        rss_collector.filter_by_word_list(input_news_items, source_include_multiple_list))
...
def test_filter_by_word_list_exclude_multiple_list(rss_collector, input_news_items, expected_news_items):
    ...
    exclude_list_results = (
        rss_collector.filter_by_word_list(input_news_items, source_exclude_multiple_list))
...
def test_filter_by_word_list_include_exclude_multiple_lists(rss_collector, input_news_items, expected_news_items):
    ...
    include_exclude_list_results = (
        rss_collector.filter_by_word_list(input_news_items, source_include_multiple_list_exclude_multiple_list))
