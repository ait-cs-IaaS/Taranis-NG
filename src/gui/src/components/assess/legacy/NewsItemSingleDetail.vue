    ...
    >
      <v-card>
        <v-toolbar v-bind="UI.DIALOG.TOOLBAR" data-dialog="single-detail">
          ...
          <v-toolbar-title class="title-limit">{{
            news_item.title
          }}</v-toolbar-title>
          <v-spacer></v-spacer>
          ...
          <div v-if="!multiSelectActive && !analyze_selector">
            ...
            <a
              v-if="canAccess"
              :href="news_item.news_items[0].news_item_data.link"
              rel="noreferrer"
              target="_blank"
            ...
            >
              <v-icon small :color="buttonStatus(news_item.read)"
                >mdi-eye</v-icon
              >
            </v-btn>
            <v-btn
            ...
            >
              <v-icon small :color="buttonStatus(news_item.important)"
                >mdi-star</v-icon
              >
            </v-btn>
            <v-btn
            ...
            >
              <v-icon small :color="buttonStatus(news_item.me_like)"
                >mdi-thumb-up</v-icon
              >
            </v-btn>
            <v-btn
            ...
            >
              <v-icon small :color="buttonStatus(news_item.me_dislike)"
            ...
            <v-row justify="center" class="px-8">
              ...
              <v-container fluid>
                <v-row>
                  ...
                  >
                    <span>{{
                      news_item.news_items[0].news_item_data.link
                    }}</span>
                  </a>
                </v-row>
              </v-container>
...
export default {
  ...
  computed: {
    ...
    canModify() {
      return (
        this.checkPermission(Permissions.ASSESS_UPDATE) && this.modify === true
      )
    },

    canDelete() {
      return (
        this.checkPermission(Permissions.ASSESS_DELETE) && this.modify === true
      )
    },
